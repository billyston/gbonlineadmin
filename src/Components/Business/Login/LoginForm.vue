        ...
        <div class="auth-box on-sidebar">
            <div id="loginform">
                ...
                <div class="logo">
                    ...
                    <h5 class="font-medium m-b-20 secondary_color mt-3">Sign In</h5>
                </div>
                <!-- End logo -->
                ...
                <div class="row">
                    <div class="col-12">
                        <form class="form-horizontal m-t-20" id="" @submit.prevent="LogIn">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="custom-control custom-checkbox d-flex align-items-center secondary_color">
                                        <input type="checkbox" class="custom-control-input" id="customCheck1">
                                        <label class="custom-control-label" for="customCheck1">Remember me</label>
                                        <a href="javascript:void(0)" id="to-recover" class="text-dark ml-auto"><i class="fa fa-lock m-r-5"></i> Forgot pwd?</a>
                                    </div>
                                </div>
                            </div>
